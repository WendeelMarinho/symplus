...
class Container_3e4009af81 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_3e4009af81 $container)
			{
	...
	public function createServiceContainer(): Container_3e4009af81
	{
		return $this;
	}
