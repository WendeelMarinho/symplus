...
class Container_09fd313de7 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				'#Call to an undefined method [a-zA-Z0-9\\\]+::(isActive|isOnTrial|isCanceled|getPlanLimits|isOverdue|isUnread)\(\)#',
				'#Method .* should return .* but returns#',
				'#Strict comparison using === between mixed and null#',
				'#Parameter .* of method .* expects .*, .* given#',
				'#Call to an undefined static method [a-zA-Z0-9\\\]+::withoutGlobalScope\(\)#',
				[
					'message' => '#Type null has already been eliminated from mixed#',
					'path' => '/var/www/html/Models/Subscription.php',
				],
			],
			true
		);
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_09fd313de7 $container)
			{
	...
	public function createServiceContainer(): Container_09fd313de7
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'memoryLimitFile' => '/var/www/html/storage/.phpstan/.memory_limit',
			'tempResultCachePath' => '/var/www/html/storage/.phpstan/resultCaches',
